...
export class SaucesService {
  ...
  tempSauces = [
    ...
    },
    {
      ...
      usersLiked: ['_574508696_id_autre_user' , '_5745867_mon_id_dans_mongo_db'],
      usersDisliked: []
    },
    {
      _id: 'eroimfgjlfh',
      ...
      mainPepper: 'Carolina Reaper',
      usersLiked: ['_5745vjksgvks67_mon_id_dans_mongo_db'],
      usersDisliked: ['_5745867_mon_id_dans_mongo_db']
    }
  ];
